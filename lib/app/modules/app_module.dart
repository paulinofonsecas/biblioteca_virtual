...
import 'package:bilioteca_virtual/presentation/admin/features/stats_and_reports/view/stats_and_reports_page.dart';
  ...
  void routes(RouteManager r) {
    ...
    r
      ...
      ..child(
        ...
        child: (context) => const StatsAndReportsPage(),
      )
